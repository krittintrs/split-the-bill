-- #8 smoke feedback: payment needs a method label (bank name / พร้อมเพย์) next to the number.
alter table bills add column payment_method text not null default '';

-- Rebuild get_bill with the new field (ADR-0006: still the only anonymous door).
