    ...
    <section className="flex flex-col gap-3 rounded-xl border border-border bg-surface p-4">
          ...
          {peersOnBill.map((peer) => (
            ...
            >
              ...
              <button
                ...
                className="flex h-11 w-11 items-center justify-center rounded-full transition hover:bg-primary-deep active:scale-95 focus-visible:outline-2 focus-visible:outline-white"
              >
                ✕
              </button>
            </span>
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          {suggestions.map((peer) => (
            <button
              ...
              className="min-h-11 rounded-full bg-surface-tint px-4 py-2 text-sm font-medium text-primary-ink transition hover:bg-border active:scale-95 focus-visible:outline-2 focus-visible:outline-primary-ink"
            >
              + {peer.name}
            </button>
          ))}
      ...
      >
        ...
        <button
          type="submit"
          disabled={!name.trim()}
          className="min-h-11 rounded-lg bg-primary px-4 text-sm font-bold text-white transition hover:bg-primary-deep active:scale-95 disabled:cursor-not-allowed disabled:opacity-40 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-ink"
        >
          เพิ่ม
        </button>
      </form>
